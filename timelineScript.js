...
document.addEventListener("DOMContentLoaded", function () {
	...
	const content = {
		...
		point9: `<img src="https://i.pinimg.com/736x/fd/a5/73/fda5735a6ef7fd072ebe2f8f02d251a4.jpg" alt="Puerto Rican Flag" style="width:100%; border-radius:10px; margin-bottom:10px;"> <p>Locals are displaced as wealthy investors take over.</p>`
	};
	...
	timelinePoints.forEach(point => {
		...
		point.addEventListener('click', function () {
			...
			if (backButton) {
				...
				backButton.style.opacity = '0.5'; // optional, to visually show it's inactive
			}
