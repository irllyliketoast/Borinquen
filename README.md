...
* **Interactive Timeline**
  Each timeline point contains hover interactions, animated video backgrounds, historical data, and accessible textual content.

* **Blender Animations**
  Nine stylized scenes created in Blender depict historical turning points, including:
...
* **Custom Cursor and Loader**
  A personalized UI experience with animated loaders and cursor design matching the project’s aesthetic.

* **Responsive Design**
  Website adapts to various screen sizes using a combination of CSS Flexbox/Grid and media queries.
